...
subscribers run loop-affine and may touch world state directly. Opening the
paperdoll (`0x88`) when you double-click a humanoid is the first of these, and
mirrors ModernUO, where the paperdoll is likewise a subscriber rather than
