...
> **Stack**: .NET 10 LTS · AOT · MoonSharp (Lua) · Snapshot+Journal persistence (MessagePack-CSharp source-gen)  
...
| Persistence | Snapshot + journal (MessagePack-CSharp source-gen) | Fast local persistence, deterministic restore, AOT-friendly |
