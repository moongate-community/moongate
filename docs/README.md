...
The `docs/` folder contains both published DocFX pages and internal project notes.

### Main notes to start from

- `docs/Home.md`: navigation hub
...
5. Keep DocFX pages in `docs/articles/` aligned with runtime behavior
