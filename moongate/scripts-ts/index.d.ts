/**
 * Moongate Server v0.19.20.0 JavaScript API TypeScript Definitions
 * Auto-generated documentation on 2025-07-24 21:06:48
 **/
...
declare const ai: {
     ...
     * @param classz IJsValue
     */
    addBrain(brainId: string, classz: IJsValue): void;
    /**
     * Add brain action
     * @param brainId string
     * @param action (arg: IAiContext) => void
     * @param receiveSpeech (arg1: IAiContext, arg2: string, arg3: IUOMobileEntity) => void
     */
    addBrainAction(brainId: string, action: (arg: IAiContext) => void, receiveSpeech: (arg1: IAiContext, arg2: string, arg3: IUOMobileEntity) => void): void;
};
...
/**
 * Generated interface for Moongate.UO.Data.Interfaces.Actions.IItemAction
 */
...
/**
 * Generated interface for Moongate.UO.Data.Contexts.AiContext
 */
interface IAiContext {
    /**
     * self
     */
    self: IUOMobileEntity;
    /**
     * currentState
     */
    currentState: string;
