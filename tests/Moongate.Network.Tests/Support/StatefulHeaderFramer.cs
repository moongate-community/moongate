...
{
    /// <summary>Width in bytes of the obfuscated header.</summary>
    ...
    /// </summary>
    /// <param name="payload">Payload bytes, sent in clear.</param>
    /// <param name="key">Running key, advanced by <see cref="HeaderLength" />.</param>
