...
public class PaperdollRendererTests
{
    ...
    public void Render_EquipmentOnASkipLayer_IsIgnored()
    {
        ...
        templates.Register(new() { Id = "pack", ItemId = 0x0E75, Equip = new() { Layer = LayerType.Backpack } });
    ...
    private static (PaperdollRenderer Renderer, FakeGumpCatalog Gumps, FakeAnimationCatalog Anim, ItemTemplateService
        Templates) Build()
    {
        ...
        return (new(gumps, anim, templates), gumps, anim, templates);
    }
}
