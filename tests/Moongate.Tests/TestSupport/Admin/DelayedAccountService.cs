...
internal sealed class DelayedAccountService : IAccountService
{
    ...
    public Task<AccountCreateResult> CreateAccountAsync(string username, string password, AccountType accountType = AccountType.Regular, CancellationToken cancellationToken = default)
