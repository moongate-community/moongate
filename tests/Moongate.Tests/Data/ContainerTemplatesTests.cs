...
public class ContainerTemplatesTests
{
    ...
    private sealed class ShippedAssets : IDisposable
    {
        ...
        public ItemEntity Item(string templateId)
        {
            ...
            return new() { Id = new(0x40000005), TemplateId = template!.Id, ItemId = template.ItemId, Amount = 1 };
        }
    ...
    [Theory, InlineData("backpack", 60), InlineData("elven_dresser_east_addon", 81),
     InlineData("elven_dresser_south_addon", 81), InlineData("arcane_bookshelf_east_addon", 263),
     InlineData("elven_wash_basin_east_addon", 260), InlineData("ornate_elven_chest_east_addon", 268),
     InlineData("boiling_cauldron_addon", 9), InlineData("closed_barrel", 62), InlineData("commodity_deed_box", 67),
     InlineData("gift_box_cube", 283), InlineData("gift_box_cylinder", 284), InlineData("gift_box_octogon", 285),
     InlineData("gift_box_angel", 287), InlineData("red_velvet_gift_box", 63), InlineData("treasure_chest_level1", 68),
     InlineData("treasure_chest_level4", 68), InlineData("basket1_artifact", 65), InlineData("basket2_artifact", 65),
     InlineData("basket3_north_artifact", 63), InlineData("basket5_west_artifact", 264), InlineData("basket6_artifact", 63),
     InlineData("chessboard", 2330), InlineData("backgammon", 2350),
    ...
    [Theory, InlineData("key_ring"), InlineData("potion_keg"), InlineData("bag_of_sending"), InlineData("bulletin_board"),
     InlineData("ballot_box"), InlineData("small_urn"), InlineData("fish_bowl"), InlineData("spellbook"),
     InlineData("necromancer_spellbook"), InlineData("dagger")]
