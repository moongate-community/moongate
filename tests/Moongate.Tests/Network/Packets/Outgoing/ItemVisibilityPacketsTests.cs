...
public class ItemVisibilityPacketsTests
{
    ...
    public void ContainerContent_HasFiveByteHeaderAndTwentyBytesPerItem()
    {
        ...
        var bytes = Serialize(
            new ContainerContentPacket(
                container,
                [
                    new(new(0x40000005), 0x0F51, 1, new(44, 65), new(0)),
                    new(new(0x40000006), 0x1517, 7, new(90, 30), new(0x21))
                ]
            )
        );
    ...
    {
        var bytes = Serialize(new ContainerContentPacket(new(0x40000001), []));
    ...
    {
        var bytes = Serialize(new DeleteObjectPacket(new(0x40000005)));
    ...
    {
        var bytes = Serialize(new DrawContainerPacket(new(0x40000009), 0x003C));
    ...
    {
        var bytes = Serialize(new WorldItemPacket(new(0x40000005), 0x0F51, 5, new(1000, 2000, -20), new(0x21)));
    ...
    public void WorldItem_MasksTheCoordinatesTheWayTheClientPacksThem()
    {
        ...
        var bytes = Serialize(new WorldItemPacket(new(1), 1, 1, new(0xFFFF, 0xFFFF, 0), new(0)));
    ...
    {
        var bytes = Serialize(new WornItemPacket(new(0x40000005), 0x1517, LayerType.Shirt, new(0x64), new(0x10)));
