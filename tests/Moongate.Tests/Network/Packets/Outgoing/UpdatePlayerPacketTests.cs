...
public class UpdatePlayerPacketTests
{
    ...
    {
        var bytes = Serialize(
            new UpdatePlayerPacket(new(0x1000), 400, 100, 200, 5, DirectionType.East, new(0x10), 3, NotorietyType.Criminal)
        );
    ...
    {
        var bytes = Serialize(
            new UpdatePlayerPacket(new(0x1000), 400, 100, 200, 5, DirectionType.East, new(0x10), 0, NotorietyType.Innocent)
        );
