...
public class AfterLoginOutgoingPacketsTests
{
    ...
    {
        var packet = GeneralInformationFactory.CreateSetCursorHueSetMap(null);
        ...
        Assert.Multiple(
            () =>
            {
                ...
                Assert.That(
                    ...
                    Is.EqualTo((ushort)GeneralInformationSubcommandType.SetCursorHueSetMap)
                );
    ...
    public void MobileDrawPacket_Write_ShouldSerializeHeaderAndTerminator()
    {
        ...
        var packet = new MobileDrawPacket(beholder, beheld, true, true);
    ...
    {
        var packet = new SeasonPacket(SeasonType.Winter);
