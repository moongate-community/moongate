...
public class DirectionTypeExtensionsTests
{
    ...
    [Theory]
    [InlineData(DirectionType.North, DirectionType.South)]
    [InlineData(DirectionType.NorthEast, DirectionType.SouthWest)]
    [InlineData(DirectionType.West, DirectionType.East)]
