...
public class SerialTests
{
    ...
    [Theory, InlineData(0x4000000Au), InlineData(1u), InlineData(0u), InlineData(uint.MaxValue)]
    ...
    [Theory, InlineData("0x40000001", 0x40000001u), InlineData("0X40000001", 0x40000001u), InlineData("40000001", 40000001u),
    ...
    public void TryParse_TakesHexWithThePrefixAndPlainDecimalWithout(string text, uint expected)
    {
        ...
        Assert.Equal(new(expected), parsed);
    }
