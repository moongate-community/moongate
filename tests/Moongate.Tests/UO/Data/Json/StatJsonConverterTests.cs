...
{
    [TestCase("\"Str\"", Stat.Strength), TestCase("\"Dex\"", Stat.Dexterity), TestCase("\"Int\"", Stat.Intelligence),
     TestCase("\"Strength\"", Stat.Strength), TestCase("\"Dexterity\"", Stat.Dexterity),
     TestCase("\"Intelligence\"", Stat.Intelligence), TestCase("0", Stat.Strength), TestCase("1", Stat.Dexterity),
