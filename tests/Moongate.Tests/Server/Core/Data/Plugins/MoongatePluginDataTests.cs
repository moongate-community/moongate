...
public sealed class MoongatePluginDataTests
{
    ...
    public void Constructor_SnapshotsDependenciesWithoutNormalizingText()
    {
        ...
        var data = new MoongatePluginData(" Example ", " Example plugin ",
            new Version(2, 0, 0), author: "", description: " ", dependencies: source);
        source.Clear();
    ...
    public void Constructor_RejectsNullDependency()
    {
        Assert.Throws<ArgumentException>(() => new MoongatePluginData(
            "plugin", "Plugin", new Version(1, 0, 0), dependencies: [null!]));
    }
    ...
    {
        Assert.Throws<ArgumentException>(() => new MoongatePluginData(
            "plugin", "Plugin", new Version(1, 0, 0), dependencies:
