...
public sealed class MoongatePluginRegistryTests
{
    ...
    public void Register_OrdersTransitiveDependenciesAndReadsMetadataOnce()
    {
        ...
        var middle = Create("middle", _ => calls.Add("middle"), [new MoongatePluginDependencyData("ROOT")]);
        var leaf = Create("leaf", _ => calls.Add("leaf"), [new MoongatePluginDependencyData("middle")]);
    ...
    public void Register_AcceptsInclusiveMinimumVersionFromExistingPlugin(string version)
    {
        ...
        var app = Create("app", dependencies: [new MoongatePluginDependencyData("CORE", new Version(1, 0, 0))]);
    ...
    public void Register_DependencyWithoutMinimumAcceptsAnyAvailableVersion()
    {
        using var container = new Container();
        var registry = new MoongatePluginRegistry(container);
        var core = Create("core", version: new Version(0, 0, 1));
        var app = Create("app", dependencies: [new MoongatePluginDependencyData("core")]);
    ...
    public void Register_MissingDependencyRejectsEntireBatchAndAllowsCorrection()
    {
        ...
        var invalid = Create("app", dependencies: [new MoongatePluginDependencyData("missing")]);
    ...
    public void Register_RejectsDuplicateIdsInBatchRegardlessOfVersion(string duplicateId)
    {
        ...
        var second = Create(duplicateId, version: new Version(2, 0, 0));
    ...
    public void Register_RejectsCyclesBeforeAnyCallback(bool selfDependency)
    {
        ...
        var first = Create("first", dependencies: [new MoongatePluginDependencyData(selfDependency ? "first" : "second")]);
        var second = Create("second", dependencies: [new MoongatePluginDependencyData("first")]);
