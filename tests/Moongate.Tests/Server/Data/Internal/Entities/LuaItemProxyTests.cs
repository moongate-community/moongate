...
public sealed class LuaItemProxyTests
{
    ...
    public void ScriptActions_ShouldHandlePropsAndSoundAndSpeech()
    {
        ...
        spatial.PlayersInRange.Add(new(new(new(new(AddressFamily.InterNetwork, SocketType.Stream, ProtocolType.Tcp)))));
        ...
        var recipients = proxy.Say("hello");
