...
public sealed class AddItemBackpackCommandTests
{
    ...
    private sealed class AddItemBackpackTestItemService : IItemService
    {
        ...
        public Task<Serial> CreateItemAsync(UOItemEntity item) => Task.FromResult((Serial)0x40000101u);
        ...
        public Task<bool> DeleteItemAsync(Serial itemId) => Task.FromResult(true);
        ...
        public Task<bool> EquipItemAsync(Serial itemId, Serial mobileId, ItemLayerType layer) => Task.FromResult(true);
        ...
        public Task<bool> MoveItemToWorldAsync(Serial itemId, Point3D location, int mapId, long sessionId = 0) => Task.FromResult(true);
    ...
    private sealed class AddItemBackpackTestGameNetworkSessionService : IGameNetworkSessionService
    {
        ...
        public GameSession GetOrCreate(MoongateTCPClient client) => throw new NotSupportedException();
    ...
    private sealed class AddItemBackpackTestCharacterService : ICharacterService
    {
        ...
        public Task<bool> AddCharacterToAccountAsync(Serial accountId, Serial characterId) => Task.FromResult(true);
        public Task<Serial> CreateCharacterAsync(UOMobileEntity character) => Task.FromResult((Serial)0x00000003u);
        ...
        public Task<bool> RemoveCharacterFromAccountAsync(Serial accountId, Serial characterId) => Task.FromResult(true);
    }
}
