...
public class ToolTipHandlerTests
{
    ...
    private sealed class TestPersistenceUnitOfWork : IPersistenceUnitOfWork
    {
        ...
        public Serial AllocateNextAccountId() => (Serial)0x00000001u;

        public Serial AllocateNextItemId() => (Serial)0x40000001u;

        public Serial AllocateNextMobileId() => (Serial)0x00000002u;
