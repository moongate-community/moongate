...
public class RegionServiceTests
{
    ...
    public void At_OverlappingRegions_ReturnsHighestPriority()
    {
        ...
        service.Register(RegionWithArea(MapType.Felucca, "Outer", 0, 0, 100, 100, 1));
        service.Register(RegionWithArea(MapType.Felucca, "Inner", 40, 40, 60, 60, 10));
    ...
    private static RegionDefinition RegionWithArea(
        MapType map,
        string name,
        int x1,
        int y1,
