...
public class OplServiceTests
{
    ...
    public void Item_Stack_UsesAmountCliloc()
    {
        ...
        var item = NewItem(items, amount: 3, name: "gold coin");
    ...
    {
        var (opl, items, _) = Build();
        var item = NewItem(items, amount: 1, name: "a dagger");
    ...
    public void Item_WithTemplateWeight_AddsWeightLine()
    {
        ...
        templates.Register(new ItemTemplate { Id = "dagger", Name = "a dagger", Weight = 5 });
        templates.Register(new ItemTemplate { Id = "feather", Name = "a feather", Weight = 1 });
    ...
    public async Task Mobile_BuildsNameLineWithSpaceSlots()
    {
        ...
        var mobile = new MobileEntity { Id = new Serial(0x00000042), Name = "Kandor" };
    ...
    public void UnknownSerial_ReturnsEmptySnapshot()
    {
        ...
        var snapshot = opl.GetOrBuild(new Serial(0x40001234));
    ...
    private static ItemEntity NewItem(
        ItemService items, int amount = 1, string name = "a dagger", string templateId = ""
    )
    {
