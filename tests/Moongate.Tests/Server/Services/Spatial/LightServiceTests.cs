...
public class LightServiceTests
{
    ...
    public void ComputeGlobalLightLevel_AfterClearingForcedOverride_ShouldReturnDynamicValue()
    {
        ...
        service.SetGlobalLightOverride(26, false);
    ...
    public void ComputeGlobalLightLevel_WithMapOffset_ShouldMatchModernUoClockStyle()
    {
        var service = CreateService();
        var levelMap0 =
            service.ComputeGlobalLightLevel(0, new(0, 0, 0), new DateTime(1997, 9, 1, 0, 0, 0, DateTimeKind.Utc));
        var levelMap1 =
            service.ComputeGlobalLightLevel(1, new(0, 0, 0), new DateTime(1997, 9, 1, 0, 0, 0, DateTimeKind.Utc));
    ...
    public void ComputeGlobalLightLevel_WithXOffset_ShouldMatchModernUoClockStyle()
    {
        ...
        var baseLevel =
            service.ComputeGlobalLightLevel(0, new(0, 0, 0), new DateTime(1997, 9, 1, 0, 0, 0, DateTimeKind.Utc));
        var shiftedLevel = service.ComputeGlobalLightLevel(
            0,
            new(4000, 0, 0),
