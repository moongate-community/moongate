...
{
    [Test]
    public async Task HandlePacketAsync_WhenQuestButtonPacketIsReceivedWithoutExtraPayload_ShouldPublishQuestJournalRequestedEvent()
    {
    ...
    [Test]
    public async Task HandlePacketAsync_WhenQuestButtonPacketIncludesLegacyPayload_ShouldStillPublishQuestJournalRequestedEvent()
    {
        var queue = new BasePacketListenerTestOutgoingPacketQueue();
        var eventBus = new NetworkServiceTestGameEventBusService();
        var handler = new QuestGumpRequestHandler(queue, eventBus);
    ...
    [Test]
    public async Task HandlePacketAsync_WhenEncodedCommandIdIsWrong_ShouldNotPublishQuestJournalRequestedEvent()
    {
        var queue = new BasePacketListenerTestOutgoingPacketQueue();
        var eventBus = new NetworkServiceTestGameEventBusService();
        var handler = new QuestGumpRequestHandler(queue, eventBus);
