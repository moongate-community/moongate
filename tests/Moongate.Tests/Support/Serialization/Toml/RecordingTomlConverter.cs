...
/// <summary>A no-op <see cref="TomlConverter{T}" /> for a type Tomlyn has no built-in converter for.</summary>
public sealed class RecordingTomlConverter : TomlConverter<RecordingTomlConverter.Marker>
{
    /// <summary>A type real enough for the registry tests, and nothing else.</summary>
