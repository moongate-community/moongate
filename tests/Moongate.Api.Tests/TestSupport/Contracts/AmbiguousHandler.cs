...
public sealed class AmbiguousHandler : IApiHandler<IncrementRequest, IncrementResponse>, IApiHandler<AlternativeRequest, IncrementResponse>
{
    ...
    public ValueTask<IncrementResponse> HandleAsync(ApiRequestContext context, AlternativeRequest request, CancellationToken cancellationToken)
        => ValueTask.FromResult(new IncrementResponse());
}
