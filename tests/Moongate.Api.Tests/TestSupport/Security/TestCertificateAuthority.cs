...
internal sealed class TestCertificateAuthority : IDisposable
{
    ...
    public TestCertificateAuthority()
    {
        ...
        var request = new CertificateRequest("CN=Moongate test CA", key, HashAlgorithmName.SHA256, RSASignaturePadding.Pkcs1);
    ...
    public X509Certificate2 Issue(string name = "localhost", bool expired = false, bool clientOnly = false)
    {
        ...
        if (!clientOnly) { usages.Add(new Oid("1.3.6.1.5.5.7.3.1")); }
