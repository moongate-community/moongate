...
/// <summary>Executes one registered command.</summary>
/// <remarks>
...
{
    /// <summary>Runs the command, writing any output into the supplied context.</summary>
    /// <param name="context">Parsed invocation and output sink.</param>
