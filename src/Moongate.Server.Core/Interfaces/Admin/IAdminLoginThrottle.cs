...
/// <summary>Bounds administrative login attempts across hosts.</summary>
public interface IAdminLoginThrottle
{
    /// <summary>Consumes one attempt for the direct peer and case-sensitive account username.</summary>
