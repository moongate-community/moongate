...
/// <summary>Drives the host through startup, its running phase, and shutdown.</summary>
/// <remarks>
...
public interface IMoongateServerBootstrap
{
    ...
    /// <summary>Stops the started services in reverse order and disposes the container.</summary>
