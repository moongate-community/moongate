...
/// <summary>
///     A service the host starts and stops as part of its own lifecycle.
/// </summary>
/// <remarks>
...
public interface IMoongateStartupService : IMoongateService
{
    ...
    /// </summary>
    /// <returns>
    ///     A task that completes when the service is ready for use.
    /// </returns>
    /// <remarks>
    ...
    /// <summary>
    ///     Stops the service and releases what it holds.
    /// </summary>
    /// <returns>
    ///     A task that completes when the service has stopped.
    /// </returns>
    /// <remarks>
    ///     Called once during shutdown, whether or not <see cref="StartAsync" /> succeeded.
    /// </remarks>
    Task StopAsync();
}
