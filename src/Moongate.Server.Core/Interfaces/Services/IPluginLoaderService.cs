...
/// <summary>
///     Loads disk plugins into the server's shared plugin registry before service startup.
/// </summary>
public interface IPluginLoaderService : IMoongateService
{
    /// <summary>
    ///     Gets internal and disk plugins registered in dependency order.
    /// </summary>
    IReadOnlyList<MoongatePluginData> Plugins { get; }

    /// <summary>
    ///     Loads and registers plugins once from the configured plugins directory.
    /// </summary>
    /// <remarks>
