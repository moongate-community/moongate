...
/// <summary>
///     Synchronously exposes borrowed transport memory. Decode or copy it before returning.
/// </summary>
public sealed class NetworkDataEventArgs : EventArgs
{
    /// <summary>
    ///     Gets the admitted connection that received the bytes.
    /// </summary>
    public INetworkConnection Connection { get; }

    /// <summary>
    ///     Gets bytes valid only during the callback. Never queue this memory for later use.
    /// </summary>
