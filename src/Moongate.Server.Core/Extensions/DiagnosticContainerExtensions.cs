...
/// <summary>
///     Registers container-owned singleton metric providers collected by the diagnostic service.
/// </summary>
public static class DiagnosticContainerExtensions
{
    /// <summary>
    ///     Registers one metric provider as an additional singleton <see cref="IMetricProvider" /> contribution.
    /// </summary>
