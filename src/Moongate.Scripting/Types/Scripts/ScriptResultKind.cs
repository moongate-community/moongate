...
public enum ScriptResultKind
{
    ...
    /// <summary>The function called <c>wait</c>. Its coroutine is parked on the timer wheel and will be resumed on the game loop; no values are returned to the caller.</summary>
    Suspended = 1,
