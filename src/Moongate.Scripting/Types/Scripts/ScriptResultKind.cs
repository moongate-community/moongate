...
/// <summary>
///     How a call into Lua ended.
/// </summary>
public enum ScriptResultKind
{
    /// <summary>
    ///     The function ran to its end; its return values are in the result.
    /// </summary>
    Completed = 0,
    ...
    ///         wait
    ///     </c>
    ///     . Its coroutine is parked on the timer wheel and will be resumed on the game loop;
