...
/// <param name="MemoryCapHits">Calls refused because their result would have exceeded the string memory cap; each one raised a script error in the caller.</param>
