...
/// <summary>
///     Outcome of a call into Lua.
/// </summary>
public sealed class ScriptResult
{
    /// <summary>
    ///     Gets the shared result of a call that suspended on
    ///     <c>
    ///         wait
    ///     </c>
    ///     : the coroutine is parked on the timer wheel and will
    ...
    /// <summary>
    ///     Gets the failure, or null unless <see cref="Kind" /> is <see cref="ScriptResultKind.Failed" />.
    /// </summary>
    ...
    /// <summary>
    ///     Creates the result of a function that ran to its end.
    /// </summary>
    /// <param name="values">
    ///     The values it returned, converted to CLR types.
    /// </param>
    /// <returns>
    ///     A <see cref="ScriptResultKind.Completed" /> result carrying <paramref name="values" />.
    /// </returns>
    ...
    /// </summary>
    /// <param name="error">
    ///     The file, line, message and Lua traceback of the failure.
    /// </param>
    /// <returns>
    ///     A <see cref="ScriptResultKind.Failed" /> result carrying <paramref name="error" />.
    /// </returns>
