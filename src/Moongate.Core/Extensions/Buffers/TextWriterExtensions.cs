...
namespace Moongate.Core.Extensions.Buffers;
...
public static class TextWriterExtensions
{
    public static void FormatBuffer(this TextWriter op, ReadOnlySpan<byte> data)
    {
        ...
        for (var i = 0; i < totalLength; i += 16)
        {
            ...
            var charsWritten = lineBytes[..length].ToSpacedHexString(lineChars);
    ...
    public static string FormatHexValue(this byte value)
