...
/// <summary>
///     Enumerates local network addresses and builds endpoints for server address listings.
/// </summary>
public static class NetworkUtils
{
    /// <summary>
    ///     Gets local endpoints with the supplied endpoint's address family and port.
    /// </summary>
    /// <param name="endPoint">
    ///     Provides the IPv4 or IPv6 family and the port to use.
    /// </param>
    /// <remarks>
    ...
    /// <summary>
    ///     Gets the unicast IPv4 and IPv6 addresses reported by all local network interfaces.
    /// </summary>
    /// <remarks>
