...
/// <summary>
///     Renders a raw packet buffer as a readable hex dump.
/// </summary>
public static class PacketFormatter
{
    ...
    /// <summary>
    ///     Formats a packet as an opcode header followed by an offset-addressed hex dump.
    /// </summary>
    /// <param name="data">
    ///     The complete packet buffer, whose first byte is the opcode.
    /// </param>
    /// <returns>
    ///     The formatted dump, using
    ///     <c>
    ///         \n
    ///     </c>
