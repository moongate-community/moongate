...
/// </summary>
/// <remarks>
/// Written as text: a bare number (<c>1150</c>) is fixed; <c>1150-1200</c> picks a fresh integer in
...
public readonly struct RangeValueSpec<T> where T : struct, INumber<T>
{
    ...
    /// <summary>Parses the text a template writer would use: a bare number, or <c>min-max</c>.</summary>
    ...
    /// <summary>Resolves the value: the fixed value, or a fresh pick in the range.</summary>
    public T Resolve()
    {
        if (!IsRandom)
        {
