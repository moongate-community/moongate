namespace Moongate.Core.Random.DiceNotation.Exceptions;
...
public class InvalidMultiplicityException : Exception
{
    ...
    /// <summary>
    /// Initializes a new instance of the InvalidMultiplicityException class with a specified error message and a reference to the
