...
public class DiceParser : IDiceParser
{
    ...
    public DiceExpression Parse(string expression)
    {
        ...
        var cleanExpression = _whitespacePattern.Replace(expression.ToLower(), "");
    ...
    {
        var constant = int.Parse(parseValues.Constant, CultureInfo.CurrentCulture);
