...
public class MoongateBootstrap
{
    ...
    public void Initialize()
    {
        ...
        {
            throw new DirectoryNotFoundException("Ultima Online directory not found or not set in the configuration.");
        }
    ...
    private MoongateServerConfig CheckAndLoadConfig(string configName)
    {
        ...
        config = JsonUtils.DeserializeFromFile<MoongateServerConfig>(configPath);
    ...
    private void ConfigureDirectories()
    {
        ...
        _directoriesConfig = new(_argsOptions.RootDirectory, Enum.GetNames<DirectoryType>());
    ...
    private void ConfigureLogging()
    {
        ...
        {
            logConfig.WriteTo.Logger(
                sub => sub
                       .Filter
                       .ByIncludingOnly(Matching.FromSource("NetworkPacket"))
                       .WriteTo
                       .File(
                           Path.Combine(_directoriesConfig[DirectoryType.Logs], "network_packets_.log"),
                           rollingInterval: RollingInterval.Day,
