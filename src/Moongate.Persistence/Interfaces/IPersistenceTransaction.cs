...
{
    /// <summary>Reads an entity and holds a PostgreSQL row lock until this transaction finishes.</summary>
    /// <remarks>Rejects zero IDs, other database targets and calls outside the callback scope.</remarks>
