...
/// <summary>
///     Configures PostgreSQL targets and explicit schema synchronization policy.
/// </summary>
public sealed class PostgreSqlPersistenceOptions
{
    ...
    /// <summary>
    ///     Gets the optional filter for targets activated by SQL alone; registered entities always activate their target.
    /// </summary>
    public Func<PersistenceDatabaseTarget, bool>? ActivateMigrationTarget { get; }

    /// <summary>
    ///     Gets the optional versioned migration catalog factory, resolved at preparation time.
    /// </summary>
    public Func<PersistenceDatabaseTarget, MigrationCatalog?>? MigrationCatalogFactory { get; }

    /// <summary>
    ///     Gets the optional explicit development migration policy.
    /// </summary>
    public DevelopmentMigrationOptions? DevelopmentMigrations { get; }

    /// <summary>
    ///     Gets whether normal initialization may apply schema changes.
    /// </summary>
    public bool AutoSynchronizeSchema { get; }

    /// <summary>
    ///     Gets the configured database targets without resolving their connection strings.
    /// </summary>
    public IReadOnlyCollection<PersistenceDatabaseTarget> ConfiguredTargets => _databases.Keys.ToArray();

    /// <summary>
    ///     Creates empty options with schema synchronization disabled.
    /// </summary>
    ...
    ///     Independently configured database targets.
    /// </param>
    /// <param name="autoSynchronizeSchema">
    ///     Whether normal initialization may apply generated schema DDL.
    /// </param>
    /// <param name="migrationCatalogFactory">
    ///     Optional immutable SQL catalog provider used for startup readiness checks.
    /// </param>
