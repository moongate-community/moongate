...
/// <summary>Configures bounded preparation and admission for a TCP listener.</summary>
public sealed record TcpServerOptions
{
    /// <summary>Gets the shared stateless framer, when no per-connection framer is supplied.</summary>
    public INetFramer? Framer { get; init; }
    /// <summary>Gets the factory for fresh per-connection pipeline configuration.</summary>
    ...
    /// <summary>Gets the maximum admitted connections, including connections being prepared.</summary>
    public int MaxConnections { get; init; } = 32;
    /// <summary>Gets the maximum streams being prepared concurrently.</summary>
    public int MaxConcurrentPreparations { get; init; } = 8;
    /// <summary>Gets the preparation timeout per accepted connection.</summary>
