...
/// <summary>
///     Controls connection preparation before outbound application I/O starts.
/// </summary>
public sealed record TcpClientOptions
{
    /// <summary>
    ///     Gets the per-connection preparation, callbacks and transport pipeline.
    /// </summary>
    ...
    /// <summary>
    ///     Gets the timeout for connecting and preparing the transport stream.
    /// </summary>
