...
///         OnDataReceived
///     </c>
///     ; protocol parsing remains the consumer's responsibility. Returning
...
///     connection, so per-connection state must be supplied fresh through
///     <c>
///         ConnectionPipeline
///     </c>
///     .
...
///     The send lock is not reentrant. Calling
///     <c>
///         SendAsync
///     </c>
///     on the same client from inside
...
public interface INetMiddleware
{
    ...
    /// </param>
    /// <returns>
    ///     Transformed bytes, or <see cref="ReadOnlyMemory{T}.Empty" /> to drop the payload.
    /// </returns>
