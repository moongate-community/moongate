...
///         ITransportCodec
///     </c>
///     runs before any frame boundary is known.
...
///         false
///     </c>
///     without touching the buffer again until the frame is complete.
...
///     consumed keystream over the header. The transport logs the exception, raises
///     <c>
///         OnException
///     </c>
...
///         ConnectionPipeline
///     </c>
///     . Stateless framers may be shared.
/// </remarks>
public interface INetFramer
{
    ...
    ///     Undefined when the method returns
    ///     <c>
    ///         false
    ///     </c>
    ///     .
    ...
    ///         true
    ///     </c>
    ///     when <paramref name="buffer" /> starts with a complete frame and
    ///     <paramref name="frameLength" /> has been written;
    ///     <c>
    ///         false
    ///     </c>
