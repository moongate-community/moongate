...
public interface INetworkConnection
{
    ...
    /// <summary>
    ///     Gets the local endpoint when exposed by the transport.
    /// </summary>
    /// <remarks>
    ///     Existing implementations without local endpoint metadata return null.
    /// </remarks>
    ...
    /// </remarks>
    /// <returns>
    ///     A task that completes when closure has been requested.
    /// </returns>
    ...
    /// </summary>
    /// <param name="payload">
    ///     Payload bytes, which the caller must keep immutable until completion.
    /// </param>
    /// <param name="cancellationToken">
    ///     The cancellation token.
    /// </param>
    ...
    /// </remarks>
    /// <returns>
    ///     A task that completes when the payload has been written.
    /// </returns>
