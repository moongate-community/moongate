namespace Moongate.Network.Interfaces.Codecs;
...
{
    /// <summary>
    ///     Transforms inbound bytes in place, before the middleware pipeline.
    /// </summary>
    /// <param name="buffer">
    ///     The bytes to transform in place.
    /// </param>
    void Decode(Span<byte> buffer);

    /// <summary>
    ///     Transforms outbound bytes in place, after the middleware pipeline.
    /// </summary>
    /// <param name="buffer">
    ///     The bytes to transform in place.
    /// </param>
