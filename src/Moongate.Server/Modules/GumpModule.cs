...
public sealed class GumpModule
{
    ...
    {
        return TryGetInt(table, key, out var value) ? value : defaultValue;
    }
    ...
    {
        return TryGetString(table, key, out var value) ? value : defaultValue;
    }
        ...
        return ContextPlaceholderRegex.Replace(
            ...
            match =>
            {
                ...
                return dyn.Type switch
                {
                    ...
                    DataType.Number  => dyn.Number.ToString("0.###############################", CultureInfo.InvariantCulture),
