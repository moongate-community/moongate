...
public sealed class GameLoopMetricsProvider : IMetricProvider
{
    ...
    public ValueTask<IReadOnlyList<MetricSample>> CollectAsync(CancellationToken cancellationToken = default)
    {
        ...
        [
            ...
            new MetricSample("oldest_queued_item_age_seconds", snapshot.OldestQueuedItemAge.TotalSeconds, "seconds",
                DiagnosticMetricType.Gauge),
            new MetricSample("accepted_work_items_total", snapshot.AcceptedWorkItems, "count",
                DiagnosticMetricType.Counter),
            new MetricSample("rejected_work_items_total", snapshot.RejectedWorkItems, "count",
                DiagnosticMetricType.Counter),
            new MetricSample("executed_work_items_total", snapshot.ExecutedWorkItems, "count",
                DiagnosticMetricType.Counter),
            ...
            new MetricSample("last_batch_duration_seconds", snapshot.LastBatchDuration.TotalSeconds, "seconds",
                DiagnosticMetricType.Gauge),
            new MetricSample("max_handler_duration_seconds", snapshot.MaxHandlerDuration.TotalSeconds, "seconds",
                DiagnosticMetricType.Gauge)
        ];
