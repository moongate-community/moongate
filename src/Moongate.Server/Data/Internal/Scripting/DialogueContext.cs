...
public sealed class DialogueContext
{
    ...
    public LuaMobileRef speaker => _speaker ??= new(_speakerMobile, _speechService, _gameNetworkSessionService);

    public LuaMobileRef listener => _listener ??= new(_listenerMobile, _speechService, _gameNetworkSessionService);
