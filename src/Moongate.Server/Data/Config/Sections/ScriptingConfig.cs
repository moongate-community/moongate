...
/// <summary>
///     TOML settings for the Lua scripting engine.
/// </summary>
public sealed class ScriptingConfig
{
    /// <summary>
    ///     Gets or sets the file executed after the prelude, relative to the scripts directory.
    /// </summary>
    public string BootstrapFile { get; set; } = "init.lua";

    /// <summary>
    ///     Gets or sets the instructions one resume may execute before it is aborted.
    /// </summary>
    ...
    /// <summary>
    ///     Gets or sets how often, in instructions, the budget hook runs.
    /// </summary>
    public int HookInterval { get; set; } = 1_000;

    /// <summary>
    ///     Gets or sets whether .luarc.json and definitions.lua are written at startup.
    /// </summary>
    public bool WriteDefinitions { get; set; } = true;

    /// <summary>
    ///     Gets or sets the largest string, in characters, that string.rep may build in one call.
    /// </summary>
    public int MaxStringLength { get; set; } = 16 * 1024 * 1024;

    /// <summary>
    ///     Maps validated TOML settings to immutable engine options, using the given scripts directory.
    /// </summary>
