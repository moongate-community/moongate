...
public static class TileData
{
    ...
    public static ItemData ItemDataByName(string name) => ItemTable.AsValueEnumerable().FirstOrDefault(x => x.Name.Equals(name, StringComparison.InvariantCultureIgnoreCase));
