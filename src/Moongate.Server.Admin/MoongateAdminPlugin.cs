...
{
    public MoongatePluginData Metadata => new(
        "com.github.moongate-community.moongate.plugins.admin", "Moongate Administration", new(1, 0), "squid",
    ...
    public void Register(Container container)
    {
        container.AddMoongateService<IAdminApiService, AdminGrpcHostService>(() =>
        {
            ...
            return new(config, container.Resolve<DirectoriesConfig>(), mode, services =>
                AdminGrpcApplication.AddServices(services, config, container.Resolve<IAdminSessionStore>(),
                    container.Resolve<IAdminLoginThrottle>(), container.Resolve<IAdminServerInfoProvider>(),
