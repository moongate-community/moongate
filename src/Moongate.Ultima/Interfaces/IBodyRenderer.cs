...
{
    /// <summary>
    ///     Every frame of an action/direction as PNG, empty when the animation is missing.
    /// </summary>
    IReadOnlyList<BodyFrame> GetBodyFrames(int body, int action, int direction, ushort hue = 0);

    /// <summary>
    ///     One PNG-encoded animation frame, or null when body/action/frame is missing.
    /// </summary>
