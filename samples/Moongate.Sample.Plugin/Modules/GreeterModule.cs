...
///         greeter
///     </c>
///     Lua module: one function, one constant, and the <see cref="Tone" /> enum it takes.
/// </summary>
...
public sealed class GreeterModule
{
    ...
    /// <summary>
    ///     The greeting used when no tone is given; visible to scripts as
    ///     <c>
    ...
    /// <summary>
    ///     Initializes a new instance of the <see cref="GreeterModule" /> class.
    /// </summary>
    /// <param name="counter">
    ///     Shared with the metric provider, which reports how often <see cref="Hello" /> ran.
    /// </param>
